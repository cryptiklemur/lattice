...
export function ClaudeSettings() {
  ...
  useEffect(function () {
    function handleMessage(msg: ServerMessage) {
      ...
      const newClaudeMd = cfg.claudeMd ? String(cfg.claudeMd) : "";
      const newModel = cfg.defaultModel ? String(cfg.defaultModel) : CLAUDE_MODELS[0].id;
      const newEffort = cfg.defaultEffort ? String(cfg.defaultEffort) : "normal";
